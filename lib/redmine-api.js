    ...
    var req = http.request(that.options, function(res) {
      ...
      res.on('data', function (chunk) {
        if (res.statusCode === 200) {
          ...
          console.log('Error: ' + res.statusCode + ", Favor verificar que su solicitud sea correcta.");
        }
      });
...
Api.prototype.getIssues = function(queryObject, callback){
  ...
  var string = "&limit="+queryObject.limit;
...
Api.prototype.updateIssue = function(doneRatio, notes, estimatedHours, spentHours){
  ...
  if (counter !== 0){
    ...
    console.log("Revise sus parámetros, no hay nueva información para enviar.");
  }
